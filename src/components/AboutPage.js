    ...
    return (
        <Box className='h-auto w-screen bg-gray-50'>
            <Box className='flex-col'>
                ...
                <Card className='w-8/12 ml-16 sm:ml-72 rounded-lg'>
                    <CardHeader title=''
                ...
                <Box className='flex socialpages justify-center space-x-10 py-8'>
                    <a href='https://github.com/QuocViNguyen' target="_blank" rel="noreferrer">
                        <Avatar alt="GitHub" src={GitHub} className='sm:w-16 h-auto hover:bg-gray-300' variant='rounded' sx={{ width:{
                            xs: 36,
                            sm: 42
                        }, 
                        height:{
                    ...
                    <a href='https://www.linkedin.com/in/quoc-nguyen-57064b194/' target="_blank" rel="noreferrer">
                        <Avatar alt="LinkedIn" src={LinkedIn} className='sm:w-16 h-auto hover:bg-gray-300' variant='rounded' sx={{ width:{
                            xs: 36,
                            sm: 42
                        }, 
                        height:{
                    ...
                    <a href='https://itch.io/c/1870755/charlesivnguyen4s-collection' target="_blank" rel="noreferrer">
                        <Avatar alt="Itch.io" src={Itchio} className='sm:w-16 h-auto hover:bg-gray-300' variant='rounded' sx={{ width:{
                            xs: 36,
                            sm: 42
                        }, 
                        height:{
                    ...
                    <a href={CV} target="_blank" rel="noreferrer">
                        <Avatar alt="My Resume" src={CVicon} className='sm:w-16 h-auto hover:bg-gray-300' variant='rounded' sx={{ width:{
                            xs: 36,
                            sm: 42
                        }, 
                        height:{
